...
class OkrugTab(models.Model):
    ...
    group = models.ForeignKey(Group, on_delete=models.SET_NULL, null=True, blank=True,
                              verbose_name='Группа пользователей', related_name='okrugs')
...
class ConfigTab(models.Model):
    ...
    # НОВЫЕ ПОЛЯ
    date_update = models.DateTimeField('Дата изменения', auto_now=True, null=True, blank=True)
    autor_update = models.CharField('Автор изменения', max_length=150, blank=True, null=True)
